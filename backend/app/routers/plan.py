"""
plan.py — Router untuk Learning Plan / Rencana Studi
"""
...
from app.services.plan_service import (
    get_rencana_by_kelas,
    generate_rencana_studi_kelas, 
    get_knowledge_state,
)
...
def list_rencana(
    ...
    """Ambil daftar rencana studi untuk satu kelas."""
    return get_rencana_by_kelas(db, kelas_id)
